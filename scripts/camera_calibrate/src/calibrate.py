...
distorted_img_filename = 'resources/img/cam-calibration/01.png'
...
square_size = 0.0424 # Length of the side of a square in meters
...
def main():
  ...
  pickle.dump(calib_result_pickle, open("camera_calib.p", "wb" )) 
